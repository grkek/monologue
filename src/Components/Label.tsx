...
class Label extends Component<Types.Any, State.LabelState> {
  kind: Readonly<Kind> = Kind.Label;
  ...
  render(): Component<Types.Any, State.LabelState> {
    return this;
  }
