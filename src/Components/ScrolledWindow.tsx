...
class ScrolledWindow extends Component<Types.Any, State.ScrolledWindowState> {
  kind: Readonly<Kind> = Kind.ScrolledWindow;
  ...
  mount(): NativeComponent {
    ...
    return new NativeComponent({
      ...
      kind: this.kind,
      //@ts-expect-error
      widget: UserInterface__ScrolledWindow(
        this.properties.id,
  ...
  render(): Component<Types.Any, State.ScrolledWindowState> {
    return this;
  }
}
